  ...
  const task1Instructions = (
    <div>
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-4">
        <p className="italic">“I’m so excited to visit your country! I’d love to know more about the best time to visit and what we can do. Also, could you suggest some interesting places to see?”</p>
      </div>
